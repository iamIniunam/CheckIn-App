...
class CustomPagedSliverGrid<PageKeyType, ItemType> extends StatelessWidget {
  const CustomPagedSliverGrid({
...
class _AppendedSliverGrid extends StatelessWidget {
  ...
  SliverChildBuilderDelegate _buildSliverDelegate({
    WidgetBuilder? appendixBuilder,
      ...
      _CustomAppendedSliverChildBuilderDelegate(
        builder: itemBuilder,
...
class _CustomAppendedSliverChildBuilderDelegate extends SliverChildBuilderDelegate  {
  _CustomAppendedSliverChildBuilderDelegate({
    ...
    childCount: appendixBuilder == null ? childCount : childCount + (appendIndicatorCount ?? 1),
    addAutomaticKeepAlives: addAutomaticKeepAlives,
    addRepaintBoundaries: addRepaintBoundaries,
    addSemanticIndexes: addSemanticIndexes,
